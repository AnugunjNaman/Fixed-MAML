...
if __name__ == '__main__':
    ...
    argparser.add_argument('--task_type', type=str, help='few-shot speech emotion recognition', default='all', choices=['es', 'en', 'it'])
    ...
    argparser.add_argument('--k_spt_train', type=int, help='number of examples per selected keyword in the support set in the meta-learning stage', default=30)
    argparser.add_argument('--k_qry_train', type=int, help='number of examples per selected keyword in the query set in the meta-learning stage', default=10)
    ...
    argparser.add_argument('--k_qry_unk_train', type=int, help='number of examples from the unknown class in the query set in the meta-learning stage', default=10)
    ...
    argparser.add_argument('--k_qry_silence_train', type=int, help='number of examples from the silence class in the query set in the meta-learning stage', default=10)
    argparser.add_argument('--k_spt_test', type=int, help='number of examples per user-defined keyword in the support set in the fine-tuning stage', default=30)
    argparser.add_argument('--k_qry_test', type=int, help='number of examples per user-defined keyword in the query set in the fine-tuning stage', default=10)
