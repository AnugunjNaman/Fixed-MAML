import torch, os
import numpy as np
from read_data import LingualData
import scipy.stats
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--task_type', type=str, help='few-shot speech emotion recognition', default='en-it', choices=['es-es', 'en-it', 'it-es'])
    ...
    argparser.add_argument('--n_way', type=int, help='n way, number of user-defined keywords', default=5)
    ...
    argparser.add_argument('--k_spt_train', type=int, help='number of examples per selected keyword in the support set in the meta-learning stage', default=10)
    argparser.add_argument('--k_qry_train', type=int, help='number of examples per selected keyword in the query set in the meta-learning stage', default=5)
    ...
    argparser.add_argument('--k_qry_unk_train', type=int, help='number of examples from the unknown class in the query set in the meta-learning stage', default=5)
    ...
    argparser.add_argument('--k_qry_silence_train', type=int, help='number of examples from the silence class in the query set in the meta-learning stage', default=5)
    argparser.add_argument('--k_spt_test', type=int, help='number of examples per user-defined keyword in the support set in the fine-tuning stage', default=10)
    argparser.add_argument('--k_qry_test', type=int, help='number of examples per user-defined keyword in the query set in the fine-tuning stage', default=25)
    ...
    argparser.add_argument('--k_qry_unk_test', type=int, help='number of examples from the unknown class in the query set in the fine-tuning stage', default=10)
    ...
    argparser.add_argument('--k_qry_silence_test', type=int, help='number of examples from the silence class in the query set in the fine-tuning stage', default=10)
    ...
    argparser.add_argument('--logdir', type=str, default='logs/lingual')
